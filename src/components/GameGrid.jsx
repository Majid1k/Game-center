...
This file shows list of games so we destructure useGames() endpoint here, object holds data(from useGames endpoint) */
  const { data, error, isLoading } = useGames(selectedGenre, selectedPlatform); // 04-filter pass selectedGenre to useGames hook, coz endpoint/fetching is shifted there from this file
